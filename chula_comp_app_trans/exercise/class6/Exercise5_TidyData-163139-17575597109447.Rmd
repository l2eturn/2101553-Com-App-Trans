...
# Make sure the 'who' dataset is loaded
data(who)

# Step 1: Gather columns into a key-value pair
df_who <- who %>%
  pivot_longer(
...
# Step 2: Replace "newrel" with "new_rel" for consistency
df_who <- df_who %>%
  mutate(key = str_replace(key, "newrel", "new_rel"))

# Step 3: Split the 'key' column by underscore
df_who <- df_who %>%
...
# Step 5: Separate 'sexage' into 'sex' and 'age'
df_who <- df_who %>%
