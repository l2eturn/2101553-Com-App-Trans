...
# (5) Are of good or better quality.
...
diamonds_ok2
# Plot diag VS sym
ggplot(diamonds_ok2, aes(diag, sym)) + stat_bin2d()
...
-   Spread: `sd(x)`, `mad(x)`, `IQR(x)`. mad = median absolute diviation (ใช้ข้อมูลที่มันเบ้มากๆๆๆๆๆๆๆๆๆ)
